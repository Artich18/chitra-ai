  ...
  return (
    <div className="min-h-screen flex" data-testid="chat-page">
      ...
      <main className="flex-1 flex flex-col h-screen md:h-auto md:min-h-screen min-w-0">
        ...
        {/* Chat surface */}
        <section className="flex-1 min-h-0 px-4 md:px-10 pb-20 md:pb-6 flex flex-col">
          <div className="flex-1 glass-strong rounded-3xl flex flex-col overflow-hidden" data-testid="chat-card">
            {/* Messages */}
            <div
              ref={scrollerRef}
              className="flex-1 overflow-y-auto scrollbar-thin px-5 md:px-8 py-6 space-y-5"
